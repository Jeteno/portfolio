export function portfolio() {
   const portfolioContent = [
      {
         href: 'http://www.bonovizio.jeteno.ru',
         title: 'Bonovizio',
      ...
      {
         href: 'http://www.bookshop.jeteno.ru',
         title: 'Bookshop',
      ...
      {
         href: 'http://www.freedom.jeteno.ru',
         title: 'Freedom',
      ...
      {
         href: 'http://www.registration.jeteno.ru',
         title: 'Registration',
      ...
      {
         href: 'http://www.youtalk.jeteno.ru',
         title: 'YouTalk',
         subtitle: 'This project is written entirely in pure HTML and SCSS',
   ...
   let displayedItemsCount = 6;
   const items = portfolioContent;

   function renderPortfolio() {
      let cards = '';
      
      for (let i = 0; i < displayedItemsCount && i < items.length; i++) {
         const item = items[i];
         const cardBlock = `
